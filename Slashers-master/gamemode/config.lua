...
-- ══════════════════════════════════════════════════════════════
--  WEAPON SELECT MODULE
-- ══════════════════════════════════════════════════════════════
-- Fallback weapon given to the killer if the weaponselect module
-- fails or if a killer somehow avoids picking (shouldn't happen
-- with the close-exploit fix, but acts as a safety net).
