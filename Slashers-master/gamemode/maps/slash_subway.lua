...
GM.MAP.Goal = {
	Generator = {
		 ...
		 {type="sls_generator", pos=Vector( 	-434.90289306641	,	587.71307373047	,	-315.77716064453	 ), ang=Angle(	-0.077189855277538	,	-121.88777160645	,	-0.095794677734375	),},
		 {type="sls_generator", pos=Vector( 	-438.56158447266	,	-319.31164550781	,	320.11373901367	 ), ang=Angle(	-0.08602774143219	,	101.84964752197	,	-0.00921630859375	),},
