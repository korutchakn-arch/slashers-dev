...
-- ─────────────────────────────────────────────
-- Shared Killer Character Table
-- Accessible on both server and client without nil errors
-- ─────────────────────────────────────────────
GM.KillerCharacters = {
	["ghostface"] = {
		name  = "Ghostface",
		desc  = GM.LANG and GM.LANG:GetString("class_desc_ghostface") or "Can see when doors are opened or closed nearby.",
	...
	["jason"] = {
		name  = "Jason",
		desc  = GM.LANG and GM.LANG:GetString("class_desc_jason") or "Can see footprints left by survivors.",
	...
	["myers"] = {
		name  = "Michael Myers",
		desc  = GM.LANG and GM.LANG:GetString("class_desc_myers") or "Slower, but can focus and spot survivors.",
	...
	["proxy"] = {
		name  = "the Proxy",
		desc  = GM.LANG and GM.LANG:GetString("class_desc_proxy") or "Can appear and disappear when out of sight.",
	...
	["intruder"] = {
		name  = "the Intruder",
		desc  = GM.LANG and GM.LANG:GetString("class_desc_intruder") or "Can place deadly traps around the map.",
